...
public class ExcluirColaboradoresUI extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ExcluirColaboradoresUI frame = new ExcluirColaboradoresUI();
	 ...
	 * Create the frame.
	 */
	public ExcluirColaboradoresUI() {
		setClosable(true);
		setTitle("Exclus\u00E3o de Colaborador");
		...
		JButton btnSalvar = new JButton("Exluir");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(selectedValue != null && !selectedValue.isEmpty()) {
						...
						new ColaboradorController().excluirColaborador(colaborador);
						JOptionPane.showMessageDialog(null, "Colaborador Excluido com Sucesso");
						dispose();
					} else {
						JOptionPane.showMessageDialog(null, "Selecione um colaborador para excluir");	
					}
				} catch (Exception ex) {
