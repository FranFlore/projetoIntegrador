...
public class ExcluirChamadosUI extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ExcluirChamadosUI frame = new ExcluirChamadosUI();
	 ...
	 * Create the frame.
	 */
	public ExcluirChamadosUI() {
		setClosable(true);
		setTitle("Exclusão de Chamado");
