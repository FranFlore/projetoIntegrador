...
public class AtualizarChamadosUI extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtualizarChamadosUI frame = new AtualizarChamadosUI();
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(selectedValue != null && !selectedValue.isEmpty()) {
						...
						if(txtDistanciaPercorrida.getText() != null && !txtDistanciaPercorrida.getText().isEmpty()) {
							double distancia = Double.parseDouble(txtDistanciaPercorrida.getText());
							chamado.setDistanciaPercorrida(distancia);
						}
						if(txtDataAbertura.getText() != null && !txtDataAbertura.getText().isEmpty()) {
							LocalDate dataAbertura = LocalDate.parse(txtDataAbertura.getText());
							chamado.setDataCriacao(dataAbertura);
						}
						if(txtDataEncerramento.getText() != null && !txtDataEncerramento.getText().isEmpty()) {
							LocalDate dataEncerramento = LocalDate.parse(txtDataEncerramento.getText());
							chamado.setDataEncerramento(dataEncerramento);
						}
						chamado.setStatus(cmbStatus.getSelectedItem().toString());
						String selectedColaborador = cmbColaborador.getSelectedItem().toString();
						String selectedVeiculo = cmbVeiculo.getSelectedItem().toString();
						if(selectedColaborador != null && !selectedColaborador.isEmpty()) {
							String[] colaboradorData = selectedColaborador.split("-");
						...
						if(selectedVeiculo != null && !selectedVeiculo.isEmpty()) {
							String[] veiculoData = selectedVeiculo.split("-");
						...
						if(cmbStatus.getSelectedItem().toString().equalsIgnoreCase("Fechado")) {
							chamado.setEmissaoCo(new ChamadoController().calculaEmissao(chamado));
						}
						new ChamadoController().atualizarChamado(chamado);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(selectedValue != null && !selectedValue.isEmpty()) {
						...
						cmbColaborador.setSelectedIndex(-1);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(selectedValue != null && !selectedValue.isEmpty()) {
						...
						txtDataEncerramento.setEnabled(true);
						txtEmissao.setText(String.valueOf(chamado.getEmissaoCo()));
						txtEmissao.setEnabled(true);
